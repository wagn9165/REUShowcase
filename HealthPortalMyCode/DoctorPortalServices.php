...
<!DOCTYPE html>
<head>
  <title>Doctor Portal Services</title>
...
<body>
  ...
  <div class="w3-bar w3-theme w3-large">
	...
	<a class="w3-bar-item w3-hide-small w3-white">Services</a>
  ...
  <!--Add Service Form-->
  <form id="servicesForm" class="center" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
    <h2>Add Service</h2>
    ...
    <div class="input-group">
	  ...
	  <select name = "service">
		<option>Select</option>;
		<?php 
		$query = "SELECT * FROM ServicesOffered;";
	...
	<!--Submit Button-->
	<div class="input-group">
	  <button type="submit" class="w3-button w3-round w3-blue w3-ripple" name="select_service">Submit New Service</button>
	</div>
